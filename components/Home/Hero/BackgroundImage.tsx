    ...
    >
      <div className="flex h-full w-full flex-col items-center justify-center bg-gray-900/30 px-8 lg:px-32">
        <div className="flex flex-col items-center gap-8 text-center">
          <h1 className="font-bold text-7xl text-white">{heroTitle}</h1>
          ...
          <div className="flex gap-4">
            {buttons.map((button) => {
              const primary =
                "inline-block rounded-lg bg-black px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base";
              const secondary =
