...
const SplitImage = ({ heroTitle, heroSubtitle, buttons, image }: Props) => {
  return (
    <div className="relative mt-24 flex flex-col-reverse py-16 lg:flex-col lg:pb-0 lg:pt-0">
      <div className="inset-y-0 right-0 top-0 z-0 mx-auto w-full max-w-xl px-4 md:px-0 lg:absolute lg:mx-0 lg:mb-0 lg:w-[70%] lg:max-w-full lg:pr-0 xl:w-[60%] xl:px-0">
        <svg
        ...
        {image?.responsiveImage && (
          <div className="relative h-48 w-full lg:h-full">
            <DatoImage
              className="h-56 w-full rounded object-cover shadow-lg md:h-96 lg:block lg:h-full lg:rounded-none lg:shadow-none"
              layout="fill"
              objectFit="cover"
              objectPosition="left"
      ...
      <div className="relative mx-auto flex w-full max-w-xl flex-col items-start px-4 md:px-0 lg:max-w-screen-2xl lg:px-8">
